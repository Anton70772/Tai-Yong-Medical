    ...
    return (
        <div className={styles.about}>
            ...
            <div className={styles.about__section}>
                ...
                <p className={styles.about__text}>
                    В 2021 году мы стали известны благодаря нашим передовым протезам, которые изменили жизнь тысяч людей. Наша приверженность качеству и инновациям позволила нам занять лидирующие позиции на мировом рынке.
                </p>
            </div>
